    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-5 offset-1">
                <form action="a_update.php" method="post" style="display:grid">
                    <table cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td><a href="admin_posts.php"><button type="button" class='btn btn-info' style="margin:5px">Back</button></a></td>
                        </tr>
                    </table>
                </form>
            </div>
