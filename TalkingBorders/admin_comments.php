...
<div class="container-fluid">
  ...
  <div class="manageComments">
      <a href="create_comment.php"><button type="button" class='btn btn-info btn-sm'>Add Comment</button></a><br><br>
              ...
              if($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                      echo "<tr>
                          ...
                          <td>".$row['postText']."</td>
                          <td>
                              &nbsp;<a href='update_comment.php?id=".$row['commentId']."'><button type='button' class='btn btn-info btn-sm'>Update</button></a>&nbsp;
