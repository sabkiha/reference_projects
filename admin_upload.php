...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-1">
        <a class="btn btn-info btn-lg" href="admin_home.php" role="button">Admin Menu</a>
    </div>  
  </div><br><br>
  ...
  <div class="row">
    <div class="col-8 offset-2">
      ...
      <p>How to name your file
        <ul>
          <li>Please use the number of the recording device in a 3-digit format: 001, 002... 044</li>
          <li>There are three parts to every experiment session:</li>
          <ol>
            <li>Monologue Citizen Scientist</li>
            <li>Monologue Border Scholar</li>
            <li>Dialogue</li>
          </ol>
          <li>Please use the user name of the Citizen Scientist to identify the experiment.</li>
          <li>Example of file name: 001_MobyDick.wav (Recording Device 001 was used by Citizen Scientist with the user name MobyDick)</li><br>
