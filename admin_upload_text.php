...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-10">
      ...
      <p>You are asked to upload three texts successively: </p>
      <ul>
        <li>Text 1: Fragment from the Citizen Scientist</li>
        <li>Text 2: Fragment from the Border Scholar</li>
        <li>Text 3: Fragment from the Dialogue</li>
      </ul>


      <form action="a_upload_text.php" method="post" style="display:grid">
