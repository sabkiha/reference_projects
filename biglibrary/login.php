 ...
 if( isset($_POST['btn-login']) ) {
  ...
  if (!$error) {
   ...
   if( $count == 1 && $row['userPass']==$password ) {
    ...
    $errMSG = "You are not registered with BigLibrary. Please follow the link to register...";
   }
  }
 }
...
<html lang="en">
<head>
  <title>Big Library Account Login</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container-fluid bg-1 text-center"> 
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
             ...
             <h2>Please log into your Big Library Account:</h2>
             <hr />
